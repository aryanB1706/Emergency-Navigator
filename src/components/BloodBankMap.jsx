  ...
  const bankIcon = useMemo(() => {
    ...
    return {
      url:
        ...
        encodeURIComponent(
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#EA4335"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm-1 11h-2v-2h2v2zm4 0h-2v-2h2v2z"/></svg>'
        ),
  ...
  const selectedBankIcon = useMemo(() => {
    ...
    return {
      url:
        "data:image/svg+xml;charset=UTF-8," +
        encodeURIComponent(
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#34A853"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm-1 11h-2v-2h2v2zm4 0h-2v-2h2v2z"/></svg>'
        ),
      ...
      directionsService.route(
        {
          origin,
          destination: {
            lat: bank.location.latitude,
            lng: bank.location.longitude,
          },
        ...
        >
          ...
          {bloodBanks.map((bank) => (
            <MarkerF
              ...
              icon={
                selectedBank?.location.latitude === bank.location.latitude
                  ? selectedBankIcon
                  : bankIcon
              }
            />
          ...
          {selectedBank && (
            <InfoWindowF
              position={{
                lat: selectedBank.location.latitude,
                lng: selectedBank.location.longitude,
              }}
